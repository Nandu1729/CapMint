# gateway-service — placeholder (not implemented)

This directory is an **intentional placeholder**, not a shipped service: it has no `src/index.ts`
and is not part of the running system. Intended future role: **API gateway (currently fulfilled by scripts/frontend-server.js)**.
