...
- Follow-ups: disposition of the quarantined certifier before certifier `NOT NULL`, PostgreSQL RLS (DM-04), JWT token revocation (denylist), the unexpiring internal ledger service token, and repository hygiene are tracked separately.
